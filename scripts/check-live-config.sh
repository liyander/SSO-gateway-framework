...
docker compose exec oauth2-proxy /bin/sh -lc 'env | sort | grep -E "OAUTH2_PROXY_OIDC_ISSUER_URL|OAUTH2_PROXY_REDIRECT_URL|OAUTH2_PROXY_INSECURE|OAUTH2_PROXY_SSL|OAUTH2_PROXY_COOKIE_SECRET"' || true
